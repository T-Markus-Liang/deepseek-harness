 ...
 */
import type { DirectoryListing, SessionId, WorkspaceFilePreview, WorkspaceGitDiff, WorkspaceGitStatus, WorkspaceId, WorkspaceTreeLevel, WorkspaceView } from '@deepseek-ai/dsh-api-remotes/client'
