...
export type { WorkspacePreviewTarget } from './contract/workbench.ts'
export type {
...
export type {
  DirectoryEntry, DirectoryListing, WorkspaceFilePreview, WorkspaceGitDiff, WorkspaceGitFile,
  WorkspaceGitStatus, WorkspaceId, WorkspaceTreeEntry, WorkspaceTreeLevel, WorkspaceView,
