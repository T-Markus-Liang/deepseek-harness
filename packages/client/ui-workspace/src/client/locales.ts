...
export const zh = {
  ...
  'delete.session': '删除会话',
  'delete.session.desc': '将永久删除会话“{name}”，其会话日志会一并从磁盘移除。此操作不可恢复。',
...
export const en = {
  ...
  'delete.session.desc': 'Permanently deletes session “{name}” and removes its session log from disk. This cannot be undone.',
