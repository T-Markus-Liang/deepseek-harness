...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'ask_user_question', 'bash', 'bash', 'best_of_n', 'cordis_define', 'cordis_inspect_list',
      'cordis_inspect_query', 'cordis_inspect_self', 'cordis_run', 'cordis_stop',
      'cordis_undefine', 'create_goal', 'edit', 'exit_plan_mode', 'followup_task', 'get_agent_result', 'get_goal', 'glob', 'grep',
      ...
      'update_goal', 'verify_candidates', 'wait_agent', 'web_fetch', 'web_search', 'workflow', 'write',
    ])
