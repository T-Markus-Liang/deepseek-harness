...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('session-live'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  z.object({ code: z.literal('session-subagent'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
